...
def test_drive_custom_camping_option():
    ...
    urban_routes_page....('East 2nd Street, 601', '1300 1st St')
    ...
    actual_value = urban_routes_page....
...
def test_add_driver_license_custom_camping_option():
    ...
    urban_routes_page....
    urban_routes_page....
    urban_routes_page....('24.04.1889')
    urban_routes_page....('01 01 123456')
    ...
    actual_value = urban_routes_page....
    ... = "Thank you!"
    assert expected_value in ..., f"Expected '{expected_value}', but got '{actual_value}'"
